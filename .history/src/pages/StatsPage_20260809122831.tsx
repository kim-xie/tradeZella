...
const StatsPage: React.FC = () => {
    ...
    if (loading) return <div className="container mx-auto p-4">Loading statistics...</div>;
    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 mb-6">
                <div className="flex items-center justify-between mb-4">
                    <Button variant="gradient" onClick={prevMonth} className="px-3 py-1 text-sm">‹</Button>
                    ...
                    <div className="flex gap-2">
                        <Button variant="gradient" onClick={goToday} className="px-3 py-1 text-sm">Today</Button>
                        <Button variant="gradient" onClick={nextMonth} className="px-3 py-1 text-sm">›</Button>
                    </div>
                </div>
