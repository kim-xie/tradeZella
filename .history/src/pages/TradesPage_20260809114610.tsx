                ...
                <tr key={trade.id} className={rowBg}>
                  ...
                  <td className={`px-5 py-5 border-b border-gray-200 dark:border-gray-700 ${rowBg} text-sm`}>
                    <div className="flex items-center justify-center">
                      <Button variant="gradient" className="mx-1 text-sm w-20 py-1 px-0 flex items-center justify-center" onClick={() => handleDetailClick(trade)}>Detail</Button>
                      <Button variant="primary" className="mx-1 text-sm w-20 py-1 px-0 flex items-center justify-center" onClick={() => handleEditClick(trade)}>Edit</Button>
                      <Button variant="gradient" className="mx-1 text-sm w-20 py-1 px-0 flex items-center justify-center bg-red-600 hover:bg-red-700" onClick={() => handleDeleteClick(trade.id)}>Delete</Button>
                    </div>
                  </td>
                </tr>
                );
