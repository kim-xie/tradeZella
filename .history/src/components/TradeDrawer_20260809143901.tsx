...
const TradeDrawer: React.FC<TradeDrawerProps> = ({ isOpen, onClose, onSuccess, trade }) => {
    ...
    const ENTRY_CONDITION_OPTIONS = [
        'Trend Follow', 'Breakout', 'Pullback', 'Reversal',
        'Support', 'Resistance', 'News', 'Indicator Signal',
        'Volume Spike', 'Pattern', 'Scalp', 'Swing',
    ];
                ...
                <div className="flex flex-col h-full">
                    ...
                    <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 space-y-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-xs text-gray-400">Click to select multiple entry conditions</p>
                        </div>
