...
import { validate, tradeValidationRules, updateTradeValidationRules } from '../middleware/validator.js';
...
router.route('/:id')
  ...
  .put(protect, updateTradeValidationRules(), validate, TradeController.updateTrade)
