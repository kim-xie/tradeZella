...
export class TradeService {
  ...
  static async updateTrade(id, userId, tradeData) {
    ...
    try {
      ...
      // Map camelCase keys from frontend to actual DB column names (all lowercase, no quotes)
      // PostgreSQL converts unquoted identifiers to lowercase, so DB columns are: entryprice, exitprice, etc.
      const fieldMap = {
      ...
      const sqlQuery = 'UPDATE trades SET ' + fields.join(', ') + ', updatedAt = CURRENT_TIMESTAMP WHERE id = 
